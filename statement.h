...
namespace ast
{
    ...
    using ReturnValue = runtime::ObjectHolder;
    ...
    */
    ...
    private:
        ...
        std::vector<std::unique_ptr<Statement>> method_args_;
    };
    ...
    */
    ...
    public:
        ...
        {
            (instructions_.emplace_back(std::move(args)), ...);
        }
    ...
    private:
        std::unique_ptr<Statement> expr_;
    };
